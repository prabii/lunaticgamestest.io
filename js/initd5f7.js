...
!(function ($) {
    ...
    var a = {
        ...
        countdown: function () {
            $(".neoh_fn_countdown").each(function () {
                var a = $(this),
                    b = a.data("type");
                if ("due_date" === b) {
                    var g = new Date(a.data("date")).getTime();
                    setInterval(function () {
                        var e = new Date().getTime(),
                            b = g - e,
                            d = Math.floor(b / 864e5),
                            f = Math.floor((b % 864e5) / 36e5),
                            h = Math.floor((b % 36e5) / 6e4),
                            i = Math.floor((b % 6e4) / 1e3),
                            c = "";
                        d > 0 && (c += d + "d: "), (c += f + "h: " + h + "m: " + i + "s"), a.text(c);
                    }, 1e3);
                } else if ("ever" === b) {
                    var c = 86400 * parseInt(a.data("days")),
                        d = 3600 * parseInt(a.data("hours")),
                        e = 60 * parseInt(a.data("minutes")),
                        f = parseInt(a.data("seconds")),
                        h = c + d + e + f;
                    setInterval(function () {
                        (c = Math.floor(h / 86400)), (d = Math.floor((h % 86400) / 3600)), (e = Math.floor((h % 3600) / 60)), (f = Math.floor(h % 60));
                        var b = "";
                        c > 0 && (b += c + "d: "), (b += d + "h: " + e + "m: " + f + "s"), a.text(b), h--;
                    }, 1e3);
                }
            });
        },
        ...
        //             b.empty(),
        //             "" === d
        //                 ? c.find(".empty_notice").slideDown(500).delay(2e3).slideUp(500)
        //                 : a.validateEmail(d)
        //                 ? $.post("modal/subscribe.html", { ajax_email: d, ajax_message: e }, function (a) {
        //                       b.append(a), b.append("<span class='contact_success'>" + f + "</span>"), b.slideDown(500).delay(4e3).slideUp(500), c.find("input").val("");
        //                   })
        //                 : b
        //                       .append("<span>" + b.data("invalid-email") + "</span>")
        //                       .slideDown(500)
        //                       .delay(4e3)
        //                       .slideUp(500),
        //             !1
        ...
        vegasSlider: function () {
            $(".neoh_fn_hero .vegas-slide").each(function () {
                ...
                a.find("input").each(function () {
                    ...
                    a.vegas({ timer: !1, animation: ["kenburnsUp", "kenburnsLeft", "kenburnsRight"], delay: 7e3, slides: b });
            });
        },
                        ...
                        on: {
                            ...
                            progress: function () {
                                for (var a = 0; a < this.slides.length; a++) {
                                    var b = this.slides[a].progress * (0.5 * this.width);
                                    $(this.slides[a])
                                        .find(".main_image")
                                        .css({ transform: "translate" + c + "(" + b + "px)" });
                                }
                            },
                            touchStart: function () {
        ...
        totop: function () {
            $(".neoh_fn_totop")
                ...
                .on("click", function (b) {
                    ...
                    return a < 500 && (a = 500), a > 1500 && (a = 1500), $("html, body").animate({ scrollTop: 0 }, a), !1;
                });
        },
        moreCategories: function () {
            $(".neoh_fn_categories").each(function () {
                ...
                if (!a.hasClass("ready")) {
                    ...
                    d * b < g && (a.append('<a href="#" class="more">' + e + " (" + (c.length - b) + ")</a>"), f.animate({ height: d * b + "px" }));
                }
            }),
                a.showMore();
        },
            ...
            $(".neoh_fn_categories .more")
                ...
                .on("click", function () {
                    var a = $(this),
                        ...
                        f = c.outerHeight(!0, !0);
                    return (
                        a.hasClass("clicked") ? (a.removeClass("clicked"), e.animate({ height: f * d + "px" }), a.text(g + " (" + (c.length - d) + ")")) : (a.addClass("clicked"), e.animate({ height: f * c.length + "px" }), a.text(h)), !1
                    );
                });
        },
        contactForm: function () {
            $(".contact_form #send_message").on("click", function () {
                ...
                return (
                    ...
                    "" === a || "" === b || "" === c
                        ? $(".contact_form div.empty_notice").slideDown(500).delay(2e3).slideUp(500)
                        : $.post("modal/contact.html", { ajax_name: a, ajax_email: b, ajax_subject: d, ajax_message: c }, function (a) {
                              $(".contact_form .returnmessage").append(a),
                                  $(".contact_form .returnmessage span.contact_error").length
                                      ? $(".contact_form .returnmessage").slideDown(500).delay(2e3).slideUp(500)
                                      : ($(".contact_form .returnmessage").append("<span class='contact_success'>" + e + "</span>"), $(".contact_form .returnmessage").slideDown(500).delay(4e3).slideUp(500)),
                    ...
                    return (
                        "on" === h
                            ...
                            : (c || (c = ""),
                              ...
                              a.find(".img_item  img_item").html('<img src="' + e + '" />'),
                              a.find(".neoh_fn_title .fn_title").text(f),
                              a.find(".desc p").text(g)),
                        a.addClass("opened"),
                        !1
                    );
                }),
        ...
        isotopeCollection: function () {
            $(".grid").isotope({ itemSelector: "li", layoutMode: "fitRows" });
        },
                    ...
                    .on("click", function () {
                        ...
                        if (b.hasClass("selected")) {
                            b.removeClass("selected"),
                                f.find('.result_item[data-id="' + d + '"]').remove(),
                                0 === c.find(".result_item").length && c.find(".clear_all").remove(),
                                b.find('input[type="checkbox"]').prop("checked", ""),
                                e.text(parseInt(e.text()) - 1);
                            var g = NeohFilterArray.indexOf(d);
                            -1 !== g && NeohFilterArray.splice(g, 1);
        ...
        recallGridAfterFiltering: function (c) {
            var a = $(".grid").isotope({ itemSelector: "li", layoutMode: "fitRows" });
            if ("clear" === c) return a.isotope({ filter: "*" }), (NeohFilterArray = []), !1;
            var b = "";
            0 === NeohFilterArray.length
                ? (b = "*")
                : $.each(NeohFilterArray, function (c, a) {
                      b += ".id" + a;
                  }),
                a.isotope({ filter: b });
        },
        removeFilter: function () {
            $(".neoh_fn_result_box .result_item a")
                ...
                .on("click", function () {
                    ...
                    e.remove(),
                        d
                            .find('.neoh_fn_filters .checkbox[data-id="' + f + '"]')
                            .removeClass("selected")
                            .find('input[type="checkbox"]')
                            .prop("checked", ""),
                        g.text(parseInt(g.text()) - 1),
                        0 === b.find(".result_item").length && b.find(".clear_all").remove();
        ...
        movingTextForNav: function () {
            ...
            if (a.length) {
                ...
                a.on("mouseenter", function (a) {
                    b.addClass("active"), b.css({ left: a.clientX + 15 + "px", top: a.clientY + 15 + "px" });
                })
                    .on("mouseleave", function () {
                        b.removeClass("active");
                    })
                    .on("mousemove", function (a) {
                        b.css({ left: a.clientX + 15 + "px", top: a.clientY + 15 + "px" });
                    });
            }
        },
        anchor: function () {
            $(".neoh_fn_down").on("click", function () {
                ...
                if ((this.pathname === window.location.pathname || -1 !== a.indexOf("#")) && $(a).length) return $([document.documentElement, document.body]).animate({ scrollTop: $(a).offset().top }, 600), !1;
            });
        },
        navFixer: function () {
            var a = $(".neoh_fn_nav .nav_footer").outerHeight();
            $(".neoh_fn_nav .nav_content").css({ height: $(window).height() - a + "px" });
        },
        movingBlog: function () {
            if ($(".neoh_fn_moving_blog").length) {
                ...
                a.on("mouseenter", function (d) {
                    ...
                    if (!c.hasClass("active")) {
                        ...
                        b.css({ backgroundImage: "url(" + e + ")" }), b.css({ left: d.clientX + 15 + "px", top: d.clientY + 15 + "px" });
                    }
                })
                    .on("mouseleave", function () {
        ...
        timeLine: function () {
            ...
            a.timelineClasses(d, b, "initial"),
                $.each(b, function (a, b) {
                    $(b)
                        .find("a")
                        .css({ left: 110 + 230 * a + "px" });
                }),
                f.css({ width: 110 + 230 * c.index() + c.find("a").width() / 2 + "px" }),
                e.css({ width: 220 + 230 * (b.length - 1) + b.last().find("a").width() / 2 + "px" }),
                g.off().on("click", function () {
                    ...
                    if (!e.hasClass("active")) {
                        var h = c.closest(".neoh_fn_timeline"),
                            g = e.data("index");
                        a.timelineClasses(d, b, g),
                            b.removeClass("active"),
                            e.addClass("active"),
                            f.css({ width: 110 + (g - 1) * 230 + c.width() / 2 + "px" }),
                            d.removeClass("active"),
                            h.find('.timeline_item[data-index="' + g + '"]').addClass("active");
                    }
                    return !1;
                });
            var j = 0,
            ...
            i.off().on("click", function () {
                return (
                    (j += -460) < e.parent().width() - e.width() ? ((j = e.parent().width() - e.width()), (k = !1)) : (k = !0),
                    j < 0 && (l = !0),
                    l ? l && h.removeClass("inactive") : h.addClass("inactive"),
                    k ? k && i.removeClass("inactive") : i.addClass("inactive"),
                    e.css({ transform: "translateX(" + j + "px)" }),
                    !1
                );
            }),
                h.off().on("click", function () {
                    return (k = !0), i.removeClass("inactive"), (j += 460) > 0 ? ((j = 0), (l = !1)) : l && (l = !0), l ? h.removeClass("inactive") : h.addClass("inactive"), e.css({ transform: "translateX(" + j + "px)" }), !1;
                });
        },
        timelineClasses: function (b, c, a) {
            ...
            $.each(b, function (c, b) {
                ...
                (e = !1),
                (d = "initial" === a ? $(".neoh_fn_timeline .progress_line .active").data("index") : a),
                $.each(c, function (c, b) {
                    if (($(b).removeClass("previous next").find(".circle").css({ filter: "none" }), "initial" === a)) {
                        if ($(b).hasClass("active")) {
                            e = !0;
                            return;
                        }
                    ...
                    e
                        ...
                        : $(b)
                              .addClass("previous")
                              .find(".circle")
                              .css({ filter: "brightness(" + (100 * (c + 1)) / d + "%)" });
                });
        },
        menuFixer: function () {
        ...
        headerTrigger: function () {
            ...
            $.each(f, function (a, b) {
                $(b).css({ transform: "translateX(" + (a + 1) * 30 + "px)", opacity: 0 });
            }),
                a.on("click", function () {
                    return (
                        a.hasClass("is-active") ||
                            (a.addClass("is-active"),
                            c.find(".trigger").addClass("is-active"),
                            b.addClass("go"),
                            c.addClass("go"),
                            setTimeout(function () {
                                $.each(f, function (a, b) {
                                    setTimeout(function () {
                                        $(b).css({ transform: "translateX(0px)", opacity: 1 });
                                    }, 200 * a);
                                });
                            }, 2e3),
                            setTimeout(function () {
                ...
                e.off().on("click", function () {
                    var i = $(this),
                        ...
                        e = i.parent();
                    return j.length
                        ? (e.hasClass("opened") ? (e.removeClass("opened"), j.slideUp()) : (e.addClass("opened"), j.slideDown(), e.siblings(".opened").removeClass("opened").find(".sub-menu").slideUp()), !1)
                        : (i.closest(".menu-item").addClass("active"),
                          d.hasClass("is-active") &&
                              ($.each(f, function (b, a) {
                                  $(a).hasClass("active") || $(a).css({ transform: "translateX(" + (b + 1) * 30 + "px)", opacity: 0 });
                              }),
                              g.removeClass("ready"),
                              h.removeClass("ready"),
                              setTimeout(function () {
        ...
        BgImg: function () {
            $("*[data-bg-img]").each(function () {
                var a = $(this),
                    ...
                    c = a.data("bg-img");
                void 0 !== b && a.css({ backgroundImage: "url(" + c + ")" });
            });
        },
    };
